...
/**
 * Represents a trivia question. This class is immutable and should be created
 * by the builder {@link TriviaQuestionBuilder}.
 * 
 * @author dspiess
 */
final public class TriviaQuestion {
	...
	/**
	 * Constructor. Intentionally package scope. This class should be created by the
	 * builder {@link TriviaQuestionBuilder}.
	 * 
	 * @param id
	 * @param question
	 * @param answerA
