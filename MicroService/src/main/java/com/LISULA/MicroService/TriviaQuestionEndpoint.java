...
public final class TriviaQuestionEndpoint {
	...
	final private TriviaQuestionAccessible dataAccess = (TriviaQuestionAccessible) new TriviaQuestionArrayAccess();
	...
	/**
	 * Returns a single question by id. If the query parameter is "random", a random
	 * question is returned. If the id is not found, 404 is returned. If the id
	 * cannot be parsed, 400 is returned.
	 * 
	 * @param uri
